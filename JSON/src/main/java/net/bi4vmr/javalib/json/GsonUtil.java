package net.bi4vmr.javalib.json;

import com.google.gson.*;
import net.bi4vmr.javalib.common.TextUtil;
...
public class GsonUtil {
    ...
    /**
     * Name        : 将JSON对象转为JSON文本
     * <p>
     * Description : 将JSON对象转为JSON文本。
     *
    ...
    /**
     * Name        : 将Java对象转为JSON文本
     * <p>
     * Description : 将Java对象转为JSON文本。
     *
    ...
    /**
     * Name        : 将Java对象转为JSON对象
     * <p>
     * Description : 将Java对象转为JSON对象。
     *
     * @param o 待转换的Java对象
     * @return JSON对象。
     */
    ...
    /**
     * Name        : 将JSON文本转换为Java对象
     * <p>
     * Description : 将JSON文本转换为Java对象。
     *
     * @param text JSON字符串
     * @param cls  实体类Class
     * @param <T>  Java对象的类型
    ...
    /**
     * Name        : 将JSON对象转换为Java对象
     * <p>
     * Description : 将JSON对象转换为Java对象。
     *
     * @param json JSON对象
     * @param cls  实体类Class
     * @param <T>  Java对象的类型
    ...
    /**
     * Name        : 将JSON数组转为JSON文本
     * <p>
     * Description : 将JSON数组转为JSON文本。
     *
    ...
    /**
     * Name        : 将实体类List转为JSON数组
     * <p>
     * Description : 将实体类List转为JSON数组。
     *
     * @param list 待转换的List
     * @return JSON数组
     */
    ...
    /**
     * Name        : 将字符串List转为JSON数组
     * <p>
     * Description : 将字符串List转为JSON数组。
     *
     * @param list 待转换的集合
     * @return JSON数组
     */
    ...
    /**
     * Name        : 将数值型List转为JSON数组
     * <p>
     * Description : 将数值型List转为JSON数组。
     *
     * @param list 待转换的集合
     * @return JSON数组
     */
    ...
    /**
     * Name        : 将布尔型List转为JSON数组
     * <p>
     * Description : 将布尔型List转为JSON数组。
     *
     * @param list 待转换的集合
     * @return JSON数组
     */
    ...
    /**
     * Name        : 将JSON文本转为JsonElement
     * <p>
     * Description : 将JSON文本转为JsonElement。
     *
     * @param text 待转换的文本

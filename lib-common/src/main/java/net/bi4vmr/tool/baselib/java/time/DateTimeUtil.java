package net.bi4vmr.tool.baselib.java.time;
...
public class DateTimeUtil {
    ...
    /**
     * Name        : 获取当前时间与日期的格式化文本（默认格式）
     * <p>
     * Description : 获取当前时间与日期的格式化文本，形如："2020-01-01 12:30:00"。
     *
     * @return 时间与日期文本
     */
    ...
    /**
     * Name        : 获取当前日期的格式化文本（默认格式）
     * <p>
     * Description : 获取当前日期的格式化文本，形如："2020-01-01"。
     *
     * @return 日期文本
     */
    ...
    /**
     * Name        : 获取当前时间的格式化文本（默认格式）
     * <p>
     * Description : 获取当前时间的格式化文本，形如："12:30:00"。
     *
     * @return 时间文本
     */
    ...
    /**
     * Name        : 获取指定日期的格式化文本（默认格式）
     * <p>
     * Description : 获取指定日期的格式化文本，形如："2020-01-01"。
     *
     * @param year  年份
     * @param month 月份
     * @param day   日期
    ...
    /**
     * Name        : 获取指定时间的格式化文本（默认格式）
     * <p>
     * Description : 获取指定时间的格式化文本，形如："12:30:00"。
     *
     * @param hour 时
     * @param min  分
     * @param sec  秒
    ...
    /**
     * Name        : 获取LocalDateTime实例
     * <p>
     * Description : 将标准格式（"yyyy-MM-dd HH:mm:ss"）时间日期文本转换为LocalDateTime实例。
     *
     * @param rawData 原始文本
     ...
     * Name        : 获取LocalDate实例
     * <p>
     * Description : 将标准格式（"yyyy-MM-dd"）日期文本转换为LocalDate实例。
     *
     * @param rawData 原始数据
     * @return LocalDate实例
     */
     ...
     * Name        : 获取LocalTime实例
     * <p>
     * Description : 将标准格式（"HH:mm:ss"）时间文本转换为LocalTime实例。
     *
     * @param rawData 原始数据
     * @return LocalTime实例
     */
    ...
    public static String[] getDateRangeOfMonth(String year, String month) {
        month = TextUtil.getSerialNumber(month, 2);
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern(FORMAT_DATETIME_DEFAULT);
    ...
    /**
     * Name        : 将SQL时间戳转换为标准格式文本
     * <p>
     * Description : 将SQL时间戳转换为标准格式文本。
     *

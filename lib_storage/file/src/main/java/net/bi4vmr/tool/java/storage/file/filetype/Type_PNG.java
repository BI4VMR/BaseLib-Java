 ...
 */
public class Type_PNG implements FileType {

    public static final String NAME = "PNG";
    public static final String INFO = "PNG";

    private final String SUFFIX_PNG = "png";

    private final String MIME_PNG = "image/png";

    private final Set<String> suffixs = Set.of(SUFFIX_PNG);
    private final Set<String> mimes = Set.of(MIME_PNG);

    private Type_PNG() {
    }

    public static Type_PNG getInstance() {
        // 返回静态内部类中的单例对象
    ...
    private static class SingletonHolder {
        private static final Type_PNG INSTANCE = new Type_PNG();
    }
}

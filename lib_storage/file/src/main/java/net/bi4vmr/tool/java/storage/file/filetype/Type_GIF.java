 ...
 */
public class Type_GIF implements FileType {

    public static final String NAME = "GIF";
    public static final String INFO = "Graphics Interchange Format";

    private final String SUFFIX_GIF = "gif";

    private final String MIME_GIF = "image/gif";

    private final Set<String> suffixs = Set.of(SUFFIX_GIF);
    private final Set<String> mimes = Set.of(MIME_GIF);

    private Type_GIF() {
    }

    public static Type_GIF getInstance() {
        // 返回静态内部类中的单例对象
    ...
    public boolean canMatch(File file) {
        ...
        // 文件头部固定为"GIF87a(474946383761)"或"GIF89a(474946383961)"
        return head.startsWith("474946383761") || head.startsWith("474946383961");
    }
    ...
    private static class SingletonHolder {
        private static final Type_GIF INSTANCE = new Type_GIF();
    }
}
